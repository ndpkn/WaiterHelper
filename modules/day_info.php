        ...
        public function examination($users_id){
            ...
            if($this->form->result && empty($this->form->err)){
                $array = array(
                    ...
                    'information_kassa' => $this->kassa,
                    'information_tips' => $this->tips,
                    'information_taxi' => $this->taxi,
                    'information_rub' => $this->rub,
